...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card">
        <div class="card-header align-items-center d-flex">
            <h4 class="card-title mb-0 flex-grow-1">Project Registration</h4>
    ...
    <div class="mb-3">
        ...
        <asp:TextBox ID="txtNewID" CssClass="form-control" placeholder="633333333X63" runat="server"  ></asp:TextBox>
            ...
            <div class="text-end">
                ...
                <asp:Button ID="btnRegister" OnClick="btnRegister_Click" CssClass="btn btn-primary" runat="server" Text="RSVP" />
        ...
        <asp:Panel ID="pnlConfirmed" Visible="false" runat="server">
            <div class="col-xl-11" style="margin: 0 auto; text-align: center;">
                <div class="card" id="crdConfirmed">
                    <div class="card-header align-items-center d-flex">
                        <h2 class="card-title mb-0 flex-grow-1">Confirmed Attendees</h2>
