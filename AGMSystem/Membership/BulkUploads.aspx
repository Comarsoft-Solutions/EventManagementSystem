    ...
    <div class="container container-boxed">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Bulk Member Registration</h4>
                        ...
                        <div class="row">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:Button ID="btnUpload" OnClick="btnUpload_Click" CssClass="btn btn-success" runat="server" Text="Upload" />&nbsp
                                    </td>
                                    <td colspan="3">
                                ...
                                <tr>
                                    <td colspan="12" style="text-align: center">
                                        <asp:Button ID="btnProcess" CssClass="btn btn-warning btn-clean" OnClick="btnProcess_Click" OnClientClick="return confirm('Are you sure want you want to upload these Members?');" runat="server" Text="Process Upload" />

                                        &nbsp
                                        <asp:Button ID="btnDiscard" CssClass="btn btn-danger btn-clean" OnClick="btnDiscard_Click" runat="server" Text="Discard Upload" />
                                    </td>
                                </tr>
                                <tr>
